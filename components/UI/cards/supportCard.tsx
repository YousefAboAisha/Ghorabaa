...
const SupportCard = ({
  ...
  return (
    <div
      className={`relative bg-white flex flex-col justify-center items-center gap-4 p-8 rounded-xl shadow-md `}
    >
      <div
      ...
      <div className="flex flex-col justify-center items-center gap-2">
        <h2 className={`font-bold text-md ${titleClassname}`}>{title}</h2>
