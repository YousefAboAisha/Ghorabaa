      ...
      <div className="flex flex-col items-start">
        ...
        <div className="flex flex-col gap-2 mt-2">
          ...
          <p className="text-[13px]">
            ...
            عسانا نَمسحُ عن وجوهِ بعضِنَا التعب ونقول سويًا "واللَّهِ ما رَأينا
            شقاءً قط". عَسانا بِمُجالسة الحبيب المُصطفى نحظىٰ وفي بَساتين الروحِ
            والرَيحانِ نركُض، وتُزيَن عُيوننا بِرؤية وَجههِ الكريم. إنَّ عزائي
            أن لقاءنا حتميُّ مهما تأجل. أسأل اللّٰه أن تكون شفيعًا لي، وأن
            يجمعنا في دار الخلود. اللهم اجعل مقامه في أعالي الجنان، وارزقني
            صبرًا يكفي لثقل هذا الفقد، واجمعنا به في مستقر رحمتك كما جمعتنا في
            الدنيا على المحبة والخير
          </p>
        </div>
