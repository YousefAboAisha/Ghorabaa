...
const Hero = () => {
  return (
    <div className="relative mt-8 bg-home-landing w-full min-h-[40vh] lg:bg-cover bg-center rounded-lg flex flex-col justify-center p-8 before:absolute before:w-full before:h-full before:left-0 before:top-0 before:bg-[#000000a4] before:rounded-lg bg-fixed">
