  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "addStory-banner": "url('/addStory.png')",
        "donation-banner": "url('/donation_banner.jpg')",
        "secondary-pattern": "url('/secondary-pattern.svg')",
        "todaysMartyr-pattern": "url('/todaysMartyr-pattern.svg')",
        "martyr-pattern": "url('/martyr-pattern.svg')",
