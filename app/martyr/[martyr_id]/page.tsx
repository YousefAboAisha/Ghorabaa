        ...
        <div className="relative p-4">
          ...
          <div className="mt-8">
            ...
            <p className="text-gray-600 text-[13px] mt-2">
              ...
              وأصير دكتور جامعي"، وبجانب تفوقه فقد كان محمد صاحبَ قضية ومبدأ،
              فلا زلت أذكر يوم عملية الشهيد البطل "خيRي علقم" البطولية، عندما
              جاء بالسيارة مسرعاً إلى بيوتنا، وقال لنا:"اليوم عيد، لازم نتحلّى"،
              ...
              والتعذيب الشديد من قبل الوحوش البشرية "الصsاينة"، لم أستوعب الخبر
              ...
              كنت قادراً على فعله هو "الصمت" ومن ثم بدأت الدموع تنهمر كالسّيل،
              فلم أجدْ وِصَالاً لروحِه غيرَ أدمُعِي". استُشهد محمد، ودُفن على
              عُجالة قرب مكان نزوحه في مدينة خانيونس، لم يودّعه أحدٌ من أصدقائه،
              بل وأنّ نسبةً كبيرة منهم علِموا نبأ استشهاده بعد فترة طويلة؛ بسبب
              شدة ووطأة الحرب وانقطاع الاتصالات تماماً في ذلك الوقت. في رعاية
              الله وحفظه يا صديقي، أنتم السابقون ونحن اللاحقون بإذن الله، رحمكَ
              اللهُ يا حبيب، والمجد لك يا شهيد، سيظلّ ذكرُك الطيّبُ والحسنُ
